          ...
          <Card className="mt-6 w-96  order border-blue-500 rounded-xl">
            ...
            <CardFooter className="pt-0">
              <button class="mt-6 px-8 py-3 bg-blue-600 text-white rounded-full hover:bg-blue-700 focus:outline-none focus:ring focus:border-blue-300">
                <Link to="/games/tictactoe">Play Now</Link>
              </button>
            </CardFooter>
          </Card>
          <Card className="mt-6 w-96  order border-blue-500 rounded-xl">
            ...
            <CardFooter className="pt-0">
              <button class="mt-6 px-8 py-3 bg-blue-600 text-white rounded-full hover:bg-blue-700 focus:outline-none focus:ring focus:border-blue-300">
                <Link to="/games/memory">Play Now</Link>
              </button>
            </CardFooter>
          </Card>
        </div>
      ...
      <div className="bg-cyan-100 space-y-6">
        <div className="text-center p-4 flex space-x-40 items-center justify-center">
          ...
          <Card className="mt-6 w-96  order border-blue-500 rounded-xl">
            ...
            <CardFooter className="pt-0">
              <button class="mt-6 px-8 py-3 bg-blue-600 text-white rounded-full hover:bg-blue-700 focus:outline-none focus:ring focus:border-blue-300">
                <Link to="/games/connectfourdisc">Play Now</Link>
              </button>
            </CardFooter>
          </Card>
        </div>
        <div className="flex justify-center items-center">
          <button class="mt-6 px-8 py-3 mb-5 bg-blue-600 text-white rounded-full hover:bg-blue-700 focus:outline-none focus:ring focus:border-blue-300">
